...
PARSER.add_argument("-n", "--n", type=_n_range, default=None, help="aaa", required=True)
PARSER.add_argument("-p", "--p", type=_p_range, default=None, help="aaa", required=True)
PARSER.add_argument("-t", "--temp", type=_t_range, default=None, help="aaa", required=True)
